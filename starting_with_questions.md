...
COMMENT: The largest total revenue generated by country is United states in a city not captured by the website. 
...
COMMENT: On average United States has the highest average of products ordered. However again the system is unable to capture the city (not available in demo dataset). It is important to understand which city is most likely to order and help create a strong market base in that city. 
...
COMMENT: United States again shows a dominant market with top products being sold by product quantity
1. Home/Office/Notebooks & Journals
2. Bags
...
COMMENT: United States with Mountain View City is again the dominant market with the top 3 products being ordered as below
